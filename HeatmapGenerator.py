...
class HeatmapGenerator ():
    ...
    def __init__ (self, pathModel, nnArchitecture, nnClassCount, transCrop):
        ...
        elif nnArchitecture == 'DENSE-NET-169': model = DenseNet169(nnClassCount, True)
        elif nnArchitecture == 'DENSE-NET-201': model = DenseNet201(nnClassCount, True)

        architectures = {
        'DENSE-NET-121': DenseNet121(nnClassCount,True),
        'DENSE-NET-169': DenseNet169(nnClasscount, True),
        'DENSE-NET-201': DenseNet201(nnClassCount, True),
